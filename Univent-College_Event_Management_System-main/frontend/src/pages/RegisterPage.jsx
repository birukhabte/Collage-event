...
const RegisterPage = () => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: "url('/Addis_Ababa_University.jpg')",
    ...
    >
      <div className="sm:mx-auto sm:w-full sm:max-w-md bg-white/10 p-8 rounded-2xl shadow-2xl backdrop-blur-xl border border-white/20 ring-1 ring-white/10">
        <h1 className="text-center text-3xl font-extrabold text-white mb-4 drop-shadow-md">College Event</h1>
        ...
        <p className="mt-2 text-center text-sm text-white text-opacity-90 drop-shadow-sm">
          Join College Event to participate in college events
        </p>
        <div className="mt-8">
